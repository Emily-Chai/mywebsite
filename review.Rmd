...
Recall the we get variance error with $\sigma^2_e(\hat{\Theta}\mid\theta)=\frac{1}{\sum_{j = 1}^{L}\frac{(p'_j)^2}{p_j(1-p_j)}}$ and $\sigma_e(\hat{\Theta}\mid\theta)=\sqrt{\frac{1}{\sum_{j = 1}^{L}\alpha^2[p_j(1-p_j)]}}$
